课程总共有30个小节，但课程只有7个单元，对应的是主线任务，其余的都是练习。
...
反对称方阵:[1_antisymmetric](c14/1_antisymmetric.py)
...
重构：[6_lookup_new](c19/6_lookup_new.py)-重写lookup
