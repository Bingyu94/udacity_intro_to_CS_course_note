# -*- coding: utf-8 -*-
"""
Created on Fri Nov 03 16:55:55 2017
...
def download_time(filesize, funits, band, bunits):
    units = {'kb':2 ** 10, 'kB':2 ** 10 * 8, 'Mb':2 ** 20, 'MB':2 ** 20 * 8, 
             'Gb':2 ** 30, 'GB':2 ** 30 * 8, 'Tb':2 ** 40, 'TB':2 ** 40 * 8}
    time = filesize*units[funits] / (band*units[bunits])
    print time
